...
<body class="body-login">
    ...
    <div id="background-login" class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
        ...
        <form method="post" action="/session" autocomplete="off">
            ...
            <input class="form-control form-login" placeholder="Password" type="password" name="password" required>
            <input type="submit" class="btn btn-primary button-login" value="LOGIN">
        </form>
    ...
    <script src="/vendor/jquery/jquery.easy-autocomplete.min.js"></script>
