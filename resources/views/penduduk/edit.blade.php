	...
	<div class="col-lg-12">
		<form method="post" action="/penduduk/{{$penduduk->id}}" autocomplete="off" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input class="form-control" placeholder="Masukkan Tempat Lahir" type="text" name="tempat_lahir" value="{{$penduduk->tempat_lahir}}" required>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input class="form-control" placeholder="Masukkan Nama Ayah" type="text" value="{{$penduduk->nama_ayah}}" name="nama_ayah">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input class="form-control" placeholder="Masukkan Nama Ibu" type="text" value="{{$penduduk->nama_ibu}}" name="nama_ibu">
				</div>
			</div>
			<br>
