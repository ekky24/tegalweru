...
@section('content')
	...
	<div class="row">
        <div class="col-lg-12">
            <h1 class="filter page-header">Data Surat Pindah Keluar</h1>
        </div>
    </div>
		...
		@foreach($pindah as $index => $row)
			...
			?>
				<tr>
					...
					<td class="text-center"><a class="btn btn-primary" style="width: 70px" href="/pindah_keluar/{{$row->id}}">Detail</a>
					<a id="hapus_kematian" class="btn btn-danger" style="width: 70px" href="/pindah_keluar/{{$row->id}}/delete">Hapus</a>
					</td>
				</tr>
		@endforeach
		</tbody>
