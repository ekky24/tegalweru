    ...
    <head>
        ...
        <body>
            <div class="size">
                ...
                <div class="isi">
                    <center><p class="header">SURAT KETERANGAN LUNAS PBB</p></center>
                        ...
                        <tr>
                            ...
                            <td>
                                <table style="margin-left: 0 !important;">
                                    ...
                                    <tr>
                                        <td>2.</td>
                                        <td>{{ strtoupper("Menerangkan bahwa PBB " . $surat->tahun_lunas . " tahun kebelakang mulai tahun ") }}
                                            <?php
                                                $now = Carbon::now();
                                                $tahun = $now->year;
                                                for ($i=0; $i < $surat->tahun_lunas; $i++) { 
                                                    echo "$tahun";
                                                    if ($i != $surat->tahun_lunas-1) {
                                                        echo ", ";
                                                    }
                                                    $tahun--;
                                                }
                                            ?>
                                            {{ strtoupper(" sudah terbayar lunas.") }}
                                        </td>
                                    </tr>
                                </table>
                            </td>
