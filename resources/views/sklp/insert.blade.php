...
<div class="row">
	<div class="col-lg-12">
		<h1 class="filter page-header">Input Surat Keterangan Lunas PBB</h1>
	</div>
</div>
<div class="row">
	<div class="col-lg-12">
		<form method="post" action="/sklp" autocomplete="off" class="form-horizontal">
			{{ csrf_field() }}
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input class="form-control" placeholder="Masukkan Jumlah Tahun Lunas PBB" type="number" name="tahun_lunas" required>
				</div>
			</div>
			<div class="form-group">
